...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  if(hi2c->Instance==I2C2)
  {
    ...
    PA12 [PA10]     ------> I2C2_SDA
    */
    GPIO_InitStruct.Pin = PCF8563_SCL_Pin|PCF8563_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C2)
  {
    ...
    PA12 [PA10]     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(PCF8563_SCL_GPIO_Port, PCF8563_SCL_Pin);

    HAL_GPIO_DeInit(PCF8563_SDA_GPIO_Port, PCF8563_SDA_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PB6     ------> USART1_TX
    */
    GPIO_InitStruct.Pin = CH340N_RX_Pin|CH340N_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PB6     ------> USART1_TX
    */
    HAL_GPIO_DeInit(GPIOB, CH340N_RX_Pin|CH340N_TX_Pin);
